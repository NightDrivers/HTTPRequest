...
public extension String {
    ...
    func localized(_ bundle: Bundle = .main) -> String {
        ...
        case .none:
            ...
            if result.isEmpty {
                result = bundle.localizedString(forKey: self, value: nil, table: "en.lproj/Localizable") 
            }
        case .zh_Hans:
            result = bundle.localizedString(forKey: self, value: nil, table: "zh-Hans.lproj/Localizable")
        case .ja:
            result = bundle.localizedString(forKey: self, value: nil, table: "ja.lproj/Localizable")
        case .en:
            result = bundle.localizedString(forKey: self, value: nil, table: "en.lproj/Localizable")
        }
        if result.isEmpty {
...
var FrameworkBundle: Bundle = {
    ...
    return Bundle.init(for: BKPopoverViewController.self)
}()
