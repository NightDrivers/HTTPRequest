...
public extension UIViewController {
    ...
    class func fromStoryboard(_ name: String, bundle: Bundle? = nil) -> Self {
        
        return UIStoryboard.init(name: name, bundle: bundle).instantiateViewController(withIdentifier: self.className) as! Self
    }
}

extension UIViewController {
    
    @objc open func bk_dismiss() {
